...
-- CUSTOMER SERVICES DROP CONSTRAINTS FK
ALTER TABLE KYC_CUSTOMER_SERVICE DROP CONSTRAINT IF EXISTS FK_KYC_CUSTOMER_SERVICE_ID_CHANNEL;
ALTER TABLE KYC_CUSTOMER_SERVICE DROP CONSTRAINT IF EXISTS FK_KYC_CUSTOMER_SERVICE_ID_SERVICE;
ALTER TABLE KYC_CUSTOMER_SERVICE DROP CONSTRAINT IF EXISTS FK_KYC_CUSTOMER_SERVICE_ID_CUSTOMER;
ALTER TABLE KYC_CUSTOMER_SERVICE DROP CONSTRAINT IF EXISTS FK_KYC_CUSTOMER_SERVICE_ID_EXECUTIVE;
...
ALTER TABLE KYC_CUSTOMER_SERVICE ADD CONSTRAINT FK_KYC_CUSTOMER_SERVICE_ID_CHANNEL
FOREIGN KEY(ID_CHANNEL) REFERENCES KYC_CHANNEL(ID) ON DELETE CASCADE;

ALTER TABLE KYC_CUSTOMER_SERVICE ADD CONSTRAINT FK_KYC_CUSTOMER_SERVICE_ID_CUSTOMER
FOREIGN KEY(ID_CUSTOMER) REFERENCES KYC_CUSTOMER(ID) ON DELETE CASCADE;

ALTER TABLE KYC_CUSTOMER_SERVICE ADD CONSTRAINT FK_KYC_CUSTOMER_SERVICE_ID_EXECUTIVE
