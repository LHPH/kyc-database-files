...
BEGIN
    ...
    P_NEIGHBOURHOOD = UPPER(P_NEIGHBOURHOOD);
    ...
    IF OPERATION = 0 THEN
        ...
        INSERT INTO KYC_CUSTOMER_ADDRESS VALUES(NEW_ID_CUSTOMER,P_STREET,P_STREET_NUMBER,P_NEIGHBOURHOOD,P_ID_STATE,CURRENT_DATE,NULL);
        COMMIT;
    ...
    ELSIF OPERATION = 1 THEN
        ...
        V_UPDATE_CUSTOMER_ADDRESS = 'UPDATE KYC_CUSTOMER_ADDRESS SET STREET=$1,STREET_NUMBER=$2,NEIGHBOURHOOD=$3';
        ...
        EXECUTE V_UPDATE_CUSTOMER_ADDRESS USING V_STREET,V_STREET_NUMBER,V_NEIGHBOURHOOD,V_ID_STATE,V_ID_CUSTOMER;
        COMMIT;
